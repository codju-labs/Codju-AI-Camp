...
const campDayContent: CampDay[] = [
  ...
  },
  {
    ...
    label: "Day 5",
    title: "Websites with AI: From Idea to Internet",
    description:
    ...
    levels: [
      ...
      { id: "aicc-web-types", title: "Types of Websites", summary: "Match different website types to the jobs they do.", dayId: "aicc-day5-website" },
      { id: "aicc-web-ai", title: "How AI Builds Websites", summary: "See how Lovable, v0, and prompts turn ideas into code.", dayId: "aicc-day5-website" },
      { id: "aicc-web-prompt", title: "Prompt Engineering for Websites", summary: "Build a strong prompt with the right site details.", dayId: "aicc-day5-website" },
      { id: "aicc-web-build", title: "Build It Live", summary: "Paste your prompt into an AI builder and iterate on the site.", dayId: "aicc-day5-website" },
      { id: "aicc-web-house", title: "From Idea to Internet", summary: "Understand frontend, backend, hosting, and domains.", dayId: "aicc-day5-website" },
      { id: "aicc-web-project", title: "Build Your Dream Website", summary: "Combine everything into a finished website project.", dayId: "aicc-day5-website" },
    ],
  },
  {
    id: "aicc-day6-agents",
    label: "Day 6",
    title: "Creating Games with AI",
    description:
    ...
    levels: [
      ...
      { id: "aicc-game-types", title: "Types of Games", summary: "Choose the right genre for the game you want to build.", dayId: "aicc-day6-agents" },
      { id: "aicc-game-ai-tools", title: "How AI Builds Games", summary: "Use AI builders like a game designer, not just a button-clicker.", dayId: "aicc-day6-agents" },
      { id: "aicc-game-prompt", title: "Prompt Engineering for Games", summary: "Turn your idea into a detailed prompt for a playable game.", dayId: "aicc-day6-agents" },
